...
그렇기 때문에 학생들이 서비스 기획, 디자인은 처음 해보는 경우가 많고 잘 할 줄도 모른다. 사이트를 만드는 법은 배웠는데 서비스 설계는 어떻게 할지, 서비스는 어떻게 꾸밀지는 배우지 않는 것이다. 우리 학교도 그랬다. 그나마 서비스 기획을 접해본 사람은 인턴 경험이 있는 나밖에 없었으며 디자인은 취미로라도 해본 사람은 없었다.
