...
우리 학교 학생은 ++주점 메뉴 및 가격, 축제 프로그램, 일정++을 가장 관심있어했고 그 다음 ++가수 라인업, 축제 동선, 학과별 행사++ 등이 뒤를 이었다. 
...
반면 타 학교 학생은 ++가수 라인업, 축제 일정, 프로그램++을 가장 관심있어했다. 그 다음 ++학교 오는길, 주점 위치, 대중교통 시간++ 등이 뒤를 이었다. 아무래도 다른 학교다보니 가수 라인업에 따라 참여 유무가 갈리는 것 같았고 찾아오는 길, 막차 시간에도 관심을 많이 두었다.
