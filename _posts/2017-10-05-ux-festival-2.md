...
저번 글에는 사이트를 만들게 된 계기를 적었었다. [지난 글 보기](https://seanlion.github.io/ux/7)

오늘은 구체적으로 기획과정을 공유해보겠다.(피드백은 환영입니다!)

흐름을 따라가기 쉽게 진행 과정은 한번 더 리뷰!
...
내 경험 상 학교 축제는 학기 중 가장 핫한 이슈 중의 하나이다. 학생들은 가수는 누가 오는지, 어떤 이벤트들을 하는지, 축제 일정은 어떻게 되는지에 대해 알고싶어한다. 그런 정보들은 대개 학교 내부에 있는 포스터, 게시판 등을 통해서 보거나 관련 페이스북 페이지 등을 통해 제공된다. 요즘은 웹 검색을 하면 일정이나 가수 라인업 등이 나오지만 정보가 혼재되어있는 경우가 많고 콘텐츠가 한정적인 경우가 많다. 관련 정보를 한 눈에 보는 것이 어렵다.

이렇다보니 정보를 모아볼 수 있는 사이트가 필요해졌다. 

‘축제 관련 정보를 일괄적으로 명확하게 제공’
...
팀에 디자이너가 없었기에 내가 기획하고 내가 디자인하고 내가 개발해야 했다. 그렇기에 만든 기획안에서 디자인 요소를 고려하고 개발 할 때 바로바로 적용하면서 수정해야했다.
...
<p align ="middle">	
 <img src="http://cfile22.uf.tistory.com/image/236A154952D001D228BE61" alt="alt text" width = "70%">
</p>
...
축제를 즐기러 오는 학생들을 대상으로 __관심있는 축제 정보__는 무엇인지에 대하여 온라인 서베이와 개인 인터뷰를 진행했다. 서베이는 총 3일 동안 진행했으며 학교 대나무숲 페이지, 지인을 대상으로 요청했다. 우리 학교 학생들과 타 대학교 학생들을 포함해 총 86명이 참여해줬다. 개인 인터뷰는 학교 학생 2명과 함께 간략하게 진행했다.
...
우리 학교 학생은 주점 메뉴 및 가격, 축제 프로그램, 일정을 가장 관심있어했고 그 다음 가수 라인업, 축제 동선, 학과별 행사 등이 뒤를 이었다. 

의외로 가수 라인업에 대한 우선순위는 상대적으로 낮았는데 아마 자기 학교 축제다보니 전반적인 일정이나 프로그램에 더욱 관심을 두지않았나 싶다.
게다가 서베이 결과 분포는 개인 인터뷰의 답변과 대부분 일치하는 모습을 보였다. 

반면 타 학교 학생은 가수 라인업, 축제 일정, 프로그램을 가장 관심있어했다. 그 다음 학교 오는길, 주점 위치, 대중교통 시간 등이 뒤를 이었다. 아무래도 다른 학교다보니 가수 라인업에 따라 참여 유무가 갈리는 것 같았고 찾아오는 길, 막차 시간에도 관심을 많이 두었다.
